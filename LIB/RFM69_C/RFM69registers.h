...
//**************************************************
#define REG_FIFO_00				0x00
#define REG_OPMODE_01			0x01
#define REG_DATAMODUL_02		0x02
#define REG_BITRATEMSB_03		0x03
#define REG_BITRATELSB_04		0x04
#define REG_FDEVMSB_05			0x05
#define REG_FDEVLSB_06			0x06
#define REG_FRFMSB_07			0x07
#define REG_FRFMID_08			0x08
#define REG_FRFLSB_09			0x09
#define REG_OSC1_0A				0x0A
#define REG_AFCCTRL_OB			0x0B
#define REG_LOWBAT_0C			0x0C
#define REG_LISTEN1_0D			0x0D
#define REG_LISTEN2_0E			0x0E
#define REG_LISTEN3_0F			0x0F
#define REG_VERSION_10			0x10
#define REG_PALEVEL_11			0x11
#define REG_PARAMP_12			0x12
#define REG_OCP_13				0x13
#define REG_AGCREF_14			0x14  // not present on RFM69/SX1231
#define REG_AGCTHRESH1_15		0x15  // not present on RFM69/SX1231
#define REG_AGCTHRESH2_16		0x16  // not present on RFM69/SX1231
#define REG_AGCTHRESH3_17		0x17  // not present on RFM69/SX1231
#define REG_LNA_18				0x18
#define REG_RXBW_19				0x19
#define REG_AFCBW_1A			0x1A
#define REG_OOKPEAK_1B			0x1B
#define REG_OOKAVG_	1C			0x1C
#define REG_OOKFIX_1D			0x1D
#define REG_AFCFEI_1E			0x1E
#define REG_AFCMSB_1F			0x1F
#define REG_AFCLSB_20			0x20
#define REG_FEIMSB_21			0x21
#define REG_FEILSB_22			0x22
#define REG_RSSICONFIG_23		0x23
#define REG_RSSIVALUE_24		0x24
#define REG_DIOMAPPING1_25		0x25
#define REG_DIOMAPPING2_26		0x26
#define REG_IRQFLAGS1_27		0x27
#define REG_IRQFLAGS2_28		0x28
#define REG_RSSITHRESH_29		0x29
#define REG_RXTIMEOUT1_2A		0x2A
#define REG_RXTIMEOUT2_2B		0x2B
#define REG_PREAMBLEMSB_2C		0x2C
#define REG_PREAMBLELSB_2D		0x2D
#define REG_SYNCCONFIG_2E		0x2E
#define REG_SYNCVALUE1_2F		0x2F
#define REG_SYNCVALUE2_30		0x30
#define REG_SYNCVALUE3_31		0x31
#define REG_SYNCVALUE4_32		0x32
#define REG_SYNCVALUE5_33		0x33
#define REG_SYNCVALUE6_34		0x34
#define REG_SYNCVALUE7_35		0x35
#define REG_SYNCVALUE8_36		0x36
#define REG_PACKETCONFIG1_37	0x37
#define REG_PAYLOADLENGTH_38	0x38
#define REG_NODEADRS_39			0x39
#define REG_BROADCASTADRS_3A	0x3A
#define REG_AUTOMODES_3B		0x3B
#define REG_FIFOTHRESH_3C		0x3C
#define REG_PACKETCONFIG2_3D	0x3D
#define REG_AESKEY1_3E			0x3E
#define REG_AESKEY2_3F			0x3F
#define REG_AESKEY3_40			0x40
#define REG_AESKEY4_41			0x41
#define REG_AESKEY5_42			0x42
#define REG_AESKEY6_43			0x43
#define REG_AESKEY7_44			0x44
#define REG_AESKEY8_45			0x45
#define REG_AESKEY9_46			0x46
#define REG_AESKEY10_47			0x47
#define REG_AESKEY11_48			0x48
#define REG_AESKEY12_49			0x49
#define REG_AESKEY13_4A			0x4A
#define REG_AESKEY14_4B			0x4B
#define REG_AESKEY15_4C			0x4C
#define REG_AESKEY16_4D			0x4D
#define REG_TEMP1_4E			0x4E
#define REG_TEMP2_4F			0x4F
#define REG_TESTLNA_58			0x58
#define REG_TESTPA1_5A			0x5A  // only present on RFM69HW/SX1231H
#define REG_TESTPA2_5C			0x5C  // only present on RFM69HW/SX1231H
#define REG_TESTDAGC_6F			0x6F
...
#define RF_FIFOTHRESH_DEF                   0x0F  // Default
...
/******************************************************************************/
#define RF69_MAX_FIFO_LENGHT 66

#define RF69_FXOSC (32000000.0)
#define RF69_FREQ_STEP (RF69_FXOSC / 524288)
